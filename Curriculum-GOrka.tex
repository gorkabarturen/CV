...
\name{Gorka}{Barturen}
\address{Gernikako Arbola 35 8ºA, Barakaldo, Bizkaia, Spain}
\mobile{606602778}

\email{gorka.barturen@opendeusto.es}
\github{gorkabarturen}
%\skype{skypeid}
%\stackoverflow{SOid}{SOname}
%\twitter{@twit}


\makecvfooter{\today}{Gorka Barturen~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
